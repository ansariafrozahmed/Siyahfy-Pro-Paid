  ...
  return (
    <div
      className={`
        ...
        ${
          variation === 1
            ? "relative w-full z-10 bg-gradient-to-b from-black/75 via-black/50 to-transparent"
            : "bg-templateBackground relative z-10"
        }
        ...
        <div className="lg:w-full flex items-center justify-center">
          <Link href="/">
            <Image
              ...
              // className={`w-full h-[50px] object-contain ${
              //   variation === 1 ? "filter invert brightness-0" : ""
              // } `}
